...
# Source: https://osf.io/h2k3t/

# List of functions:

#   renk_no_bias()
#       Simulates the no bias condition

#   renk_100prcnt_bias()
#       Simulates the 100% bias condition

#   renk_optional_stopping()
#       Simulates the optional stopping condition

#   renk_two_step_bias()
#       Simulates the two-step bias condition

#   renk_90prcnt_bias()
#       Simulates the 90% bias condition
...
renk_no_bias <- function(m, k, n_min, n_max, m1g, Tau, sd1, m2, sd2) {
  ...
  for (b in 1:m)
  {
    ...
    while (i<=k)
    {
      ...
      power = pwr.t2n.test(m1g, n1 = n, n2 = n)
